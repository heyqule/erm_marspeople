...
local spawn_table = function(level)
    local res = {}
    --Tier 1
    res[1] = { MOD_NAME .. '/marspeople/' ..            level, { { 0.0, 0.9 }, { 0.2, 0.5 }, { 0.4, 0.35 }, { 0.6, 0.25 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }
    res[2] = { MOD_NAME .. '/miniufo/' ..               level, { { 0.0, 0.1 }, { 0.2, 0.35 }, { 0.4, 0.35 }, { 0.6, 0.25 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }

    --Tier 2
    res[3] = { MOD_NAME .. '/marspeople-icy/' ..        level, { { 0.0, 0.0 }, { 0.2, 0.05 }, { 0.4, 0.1 }, { 0.6, 0.2 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    res[4] = { MOD_NAME .. '/eye-ufo-a/' ..             level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.05 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }
    res[5] = { MOD_NAME .. '/daimanji-dropship/' ..     level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.05 }, { 0.8, 0.05 }, { 1.0, 0.1 } } }
    res[6] = { MOD_NAME .. '/marspeople-builder/' ..    level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.05 }, { 0.8, 0.05 }, { 1.0, 0.1 } } }
    res[7] = { MOD_NAME .. '/eye-ufo-b/' ..             level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.1 }, { 0.6, 0.15 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    ...
    res[10] = { MOD_NAME .. '/daimanji-purpleball/' ..  level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    res[11] = { MOD_NAME .. '/daimanji-thunderbolt/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    return res
end
...
function ErmMarsPeople.make_tencore(level)
    level = level or 1
    ...
    data:extend({
        {
            ...
            icon = "__erm_marspeople__/graphics/entity/icons/buildings/tencore.png",
            icon_size = 64,
            ...
            animations = {
                layers = {
                    {
                        filename = "__erm_marspeople__/graphics/entity/buildings/tencore.png",
                        width = 192,
                        height = 192,
                        frame_count = 5,
                        animation_speed = 0.1,
