...
local spawn_table = function(level)
    local res = {}
    --Tire 1
    res[1] = { MOD_NAME .. '/marspeople/' .. level,           { { 0.0, 0.2 }, { 0.2, 0.2 }, { 0.4, 0.2 }, { 0.6, 0.2 }, { 0.8, 0.2 }, { 1.0, 0.2 } } }

    --Tire 2
    res[2] = { MOD_NAME .. '/miniufo/' .. level,           { { 0.0, 0.2 }, { 0.2, 0.2 }, { 0.4, 0.2 }, { 0.6, 0.2 }, { 0.8, 0.2 }, { 1.0, 0.2 } } }
    res[3] = { MOD_NAME .. '/marspeople-icy/' .. level,           { { 0.0, 0.2 }, { 0.2, 0.2 }, { 0.4, 0.2 }, { 0.6, 0.2 }, { 0.8, 0.2 }, { 1.0, 0.2 } } }

    res[4] = { MOD_NAME .. '/marspeople-fire/' .. level,           { { 0.0, 0.2 }, { 0.2, 0.2 }, { 0.4, 0.2 }, { 0.6, 0.2 }, { 0.8, 0.2 }, { 1.0, 0.2 } } }
    res[5] = { MOD_NAME .. '/ufo/' .. level,           { { 0.0, 0.2 }, { 0.2, 0.2 }, { 0.4, 0.2 }, { 0.6, 0.2 }, { 0.8, 0.2 }, { 1.0, 0.2 } } }
...
function ErmMarsPeople.make_lab(level)
    level = level or 1
