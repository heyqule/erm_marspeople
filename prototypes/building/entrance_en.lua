...
local spawn_table = function(level)
    ...
    --Tier 2
    res[3] = { MOD_NAME .. '/marspeople-icy/' ..        level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.2 }, { 0.8, 0.15 }, { 1.0, 0.1 } } }
    res[4] = { MOD_NAME .. '/eye-ufo-a/' ..             level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.15 }, { 0.8, 0.15 }, { 1.0, 0.1 } } }
    res[5] = { MOD_NAME .. '/daimanji-dropship/' ..     level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.05 } } }
    res[6] = { MOD_NAME .. '/marspeople-builder/' ..    level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.1 } } }
    res[7] = { MOD_NAME .. '/eye-ufo-b/' ..             level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.05 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
