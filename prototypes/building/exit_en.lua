...
local spawn_table = function(level)
    local res = {}
    --Tier 1
    res[1] = { MOD_NAME .. '/marspeople/' ..            level, { { 0.0, 0.9 }, { 0.2, 0.6 }, { 0.4, 0.4 }, { 0.6, 0.3 }, { 0.8, 0.2 }, { 1.0, 0.15 } } }
    res[2] = { MOD_NAME .. '/miniufo/' ..               level, { { 0.0, 0.1 }, { 0.2, 0.4 }, { 0.4, 0.35 }, { 0.6, 0.3 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }

    --Tier 2
    res[3] = { MOD_NAME .. '/marspeople-icy/' ..        level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.1 }, { 0.6, 0.2 }, { 0.8, 0.1 }, { 1.0, 0.15 } } }
    res[4] = { MOD_NAME .. '/eye-ufo-a/' ..             level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.05 }, { 0.8, 0.15 }, { 1.0, 0.1 } } }
    ...
    res[7] = { MOD_NAME .. '/eye-ufo-b/' ..             level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.1 }, { 0.6, 0.15 }, { 0.8, 0.15 }, { 1.0, 0.1 } } }
...
function ErmMarsPeople.make_exit_en(level)
    level = level or 1
